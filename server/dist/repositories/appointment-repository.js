...
export class AppointmentRepository extends BaseRepository {
    ...
    async create(appointment) {
        ...
        try {
            // Ensure UTC timezone
            await client.query('SET TIMEZONE = \'UTC\'');
            const result = await client.query('INSERT INTO appointments (client, type, status, scheduled_datetime, description, answered) VALUES ($1, $2, $3, $4::timestamp, $5, $6) RETURNING *', [appointment.client, appointment.type, appointment.status, appointment.scheduled_datetime, appointment.description, appointment.answered]);
    ...
    async update(id, appointment) {
        ...
        try {
            // Ensure UTC timezone
            await client.query('SET TIMEZONE = \'UTC\'');
            const result = await client.query('UPDATE appointments SET client = $1, type = $2, status = $3, scheduled_datetime = $4::timestamp, description = $5, answered = $6, updated_at = CURRENT_TIMESTAMP WHERE id = $7 RETURNING *', [appointment.client, appointment.type, appointment.status, appointment.scheduled_datetime, appointment.description, appointment.answered, id]);
